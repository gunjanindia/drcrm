...
export default function ClientsPage() {
  const [clients, setClients] = useState(globalStore.clients);
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500">
            {clients.length} Local Businesses across Jharkhand with active services and automated task schedules.
          </p>
        </div>
      </div>
