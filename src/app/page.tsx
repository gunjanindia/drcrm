...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white">
      ...
      {/* TOP ANNOUNCEMENT BANNER FOR CLIENT 360 SAAS */}
      <div className="bg-gradient-to-r from-indigo-900 via-purple-900 to-slate-950 text-white px-4 py-2.5 text-xs font-bold border-b border-indigo-500/30 flex items-center justify-center gap-2 text-center shadow-md relative z-20">
        <span className="px-2 py-0.5 rounded-full bg-purple-500/30 text-purple-300 text-[10px] font-black uppercase tracking-wider border border-purple-400/30">
          ✨ New Release
        </span>
        <span>
          <strong>Get Started with Client 360 Growth Suite:</strong> 14-Day Free Demo Trial with 20 Gemini AI Credits Included!
        </span>
        <Link
          href="/register"
      ...
      <section className="relative overflow-hidden pt-10 pb-16 md:pt-16 md:pb-24">
        ...
        <div className="absolute top-10 left-1/2 -translate-x-1/2 w-[700px] h-[400px] bg-gradient-to-tr from-indigo-500/20 via-purple-500/15 to-sky-400/20 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto space-y-6">
            ...
            {/* CTA Group with prominent Client 360 Growth Suite registration */}
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
              <Link href="/register" className="w-full sm:w-auto">
                <Button
                  ...
                  size="lg"
                  icon={Sparkles}
                  className="w-full bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 hover:from-indigo-700 hover:to-purple-700 text-white font-extrabold shadow-xl shadow-indigo-600/30 scale-105 sm:scale-100 hover:scale-105 transition-all"
                >
                  Get Started with Client 360 (Free Trial)
                </Button>
              </Link>
            ...
            <div className="pt-6 flex flex-wrap items-center justify-center gap-6 text-xs font-semibold text-slate-500 dark:text-slate-400">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span>14-Day Free Demo (No Card Needed)</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* ========================================================================= */}
      {/* 2. PROMINENT SPOTLIGHT: GET STARTED WITH CLIENT 360 GROWTH SUITE          */}
      {/* ========================================================================= */}
      <section className="py-16 bg-gradient-to-b from-slate-900 via-indigo-950/60 to-slate-900 text-white border-y border-indigo-500/20 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          
          <div className="text-center max-w-3xl mx-auto mb-12 space-y-3">
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full text-xs font-black bg-indigo-500/20 text-indigo-300 border border-indigo-500/30">
              <Sparkles className="w-3.5 h-3.5 text-amber-400" />
              <span>SaaS Growth Platform</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-black tracking-tight text-white">
              Get Started with Client 360 Growth Suite
            </h2>
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed max-w-2xl mx-auto">
              Everything you need to dominate local Google search in Ranchi, Dhanbad, Jamshedpur & Jharkhand. Manage reviews, deploy a 1-page website, and convert searches into paying clients.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {/* Card 1 */}
            <div className="p-6 rounded-3xl bg-slate-900/80 border border-indigo-500/30 hover:border-indigo-500/60 transition-all space-y-3 shadow-xl hover:-translate-y-1">
              ...
              <p className="text-xs text-slate-300 leading-relaxed">
                Rank in the Top 3 Map Pack when local customers search for your treatments, services, or products near them.
              </p>
            </div>

            {/* Card 2 */}
            <div className="p-6 rounded-3xl bg-slate-900/80 border border-purple-500/30 hover:border-purple-500/60 transition-all space-y-3 shadow-xl hover:-translate-y-1">
              <div className="w-12 h-12 rounded-2xl bg-purple-600/20 text-purple-400 flex items-center justify-center font-black">
                <Sparkles className="w-6 h-6" />
              </div>
              <h3 className="text-base font-black text-white">
                Gemini AI Review Replies
              </h3>
              <p className="text-xs text-slate-300 leading-relaxed">
                Automate responses to Google Maps reviews in 1-click using 20 free Gemini AI credits to maximize customer retention.
              </p>
            </div>

            {/* Card 3 */}
            <div className="p-6 rounded-3xl bg-slate-900/80 border border-sky-500/30 hover:border-sky-500/60 transition-all space-y-3 shadow-xl hover:-translate-y-1">
              <div className="w-12 h-12 rounded-2xl bg-sky-600/20 text-sky-400 flex items-center justify-center font-black">
                <Globe className="w-6 h-6" />
              </div>
              <h3 className="text-base font-black text-white">
                Instant 1-Page Mini Site
              </h3>
              <p className="text-xs text-slate-300 leading-relaxed">
                Get a mobile-optimized website with direct WhatsApp chat, call CTAs, services menu, and photo gallery ready in minutes.
              </p>
            </div>

            {/* Card 4 */}
            <div className="p-6 rounded-3xl bg-slate-900/80 border border-emerald-500/30 hover:border-emerald-500/60 transition-all space-y-3 shadow-xl hover:-translate-y-1">
              ...
              <p className="text-xs text-slate-300 leading-relaxed">
                Track direction requests, calls, website clicks, and revenue growth with automatic monthly performance reports.
              </p>
            </div>
          </div>

          {/* Interactive Action Bar */}
          <div className="mt-10 p-6 rounded-3xl bg-gradient-to-r from-indigo-950 via-slate-900 to-purple-950 border border-indigo-500/40 flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl">
            <div className="space-y-1 text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start gap-2">
                ...
                <span className="text-xs font-bold text-slate-300">
                  Includes 20 AI Credits • ₹1,500/mo after trial
                </span>
              </div>
              <h3 className="text-lg font-black text-white">
                Ready to dominate your city's local search market?
              </h3>
            </div>
            ...
            <Link href="/register" className="shrink-0 w-full md:w-auto">
              <Button
                ...
                size="lg"
                icon={Sparkles}
                className="w-full bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-extrabold shadow-xl shadow-indigo-600/40 text-xs py-3.5 px-8"
              >
