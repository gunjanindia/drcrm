      ...
      <div className="p-6 rounded-3xl bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 border border-indigo-500/30 text-white shadow-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <Button
            ...
            className="bg-white/10 text-white hover:bg-white/20 border-white/20 text-xs py-2 px-3.5 font-bold shadow-xs"
          >
            {isSyncing ? 'Syncing Profile...' : 'Sync Google Data'}
          </Button>
          ...
          {client.googleMapsUrl && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-3.5 py-2 rounded-xl bg-white/10 hover:bg-white/20 border border-white/20 text-xs font-bold text-white transition-all flex items-center gap-1.5 shadow-xs"
            >
