...
export const DEFAULT_MINI_SITE: MiniSiteConfig = {
  category: 'RETAIL',
  headline: 'Prime Retail & Lifestyle Store',
  subheadline: 'Premium Quality Products, Authentic Brands & Dedicated Local Service',
  tagline: 'Top Rated Local Business • 4.9⭐ on Google Maps',
  aboutText: 'Serving our community since 2018, we bring you curated collections, 100% authentic quality, transparent pricing, and fast customer service. Visit our store or place direct inquiries via WhatsApp.',
  ownerName: 'Store Manager',
  ownerTitle: 'Founder & Managing Director',
  services: [
    { title: 'New Seasonal Collection', desc: 'Curated premium quality arrivals.', price: '₹499 onwards', icon: 'Sparkles' },
    { title: 'Express In-Store Pickup', desc: 'Browse catalog on WhatsApp & pickup in 30 mins.', price: 'Free', icon: 'CheckCircle2' },
    { title: 'Custom Consultations', desc: 'Expert customer assistance available on site.', price: 'Free', icon: 'ShieldCheck' },
    { title: 'Gift Vouchers & Packages', desc: 'Customizable gift packages for special occasions.', price: '₹500 - ₹5,000', icon: 'Star' },
  ],
